...
<br>Στο bonus διερευνήθηκε και η κάμερα Kinect.
...
![ScreenShot](Report_materials/se4.1.jpg)
![ScreenShot](Report_materials/se4.2.jpg)
![ScreenShot](Report_materials/se4.3.jpg)
...
![Alt Text](Report_materials/se4.4.gif)
...
![Alt Text](Report_materials/se4.5.gif)
...
![Alt Text](Report_materials/se4.6.gif)
...
# Conclusions
Μέσα από τα παραδοτέα έμαθα καλά το Processing και τις δυνατότητές του. Βασικό απόκτημα από το μάθημα είναι η συνειδητοποίηση της ποικιλίας που υπάρχει στους τρόπους αλληλεπίδρασης με τις ψηφιακές εφαρμογές και πως βελτιώνουν την εμεπιρία χρήστη, καθώς και οι διαφορετικοί τρόποι που μπορεί να επιτευχθεί ο ίδιος στόχος.(πχ. με ή χωρίς κάποια βιβλιοθήκη).

Τέλος, το Bonus προσέθεσε στην εμπειρία, καθώς η Kinect έδινε πιο ακριβή αποτελέσματα και η προσθήκη του αισθητήρα βάθους, σε συνεργασία με τη βιβλιοθήκη της, έδινε την ευκαιρία για περισσότερες εφαρμογές και βελτιωμένη εμπειρία χρήστη.
