...
Αρχικά, άνοιξα το παράδειγμα 16-12. Όρισα μια μεταβλητή Movie για να μπορέσω να χρησιμοποιήσω ένα βίντεο για την αντικατάσταση του background. Κατέβασα ένα βίντεο της επιλογής μου και το έκοψα, ώστε να μην ξεπερναι τα 10" και το έκανα drag and drop στο πρόγραμμα, βάζοντας το αυτόματα στν φάκελο data του προγράμματος.
